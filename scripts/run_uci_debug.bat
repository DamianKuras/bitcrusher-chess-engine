...
premake5 vs2022 --with-uci --with-bmi2
...
REM Build and run
cd build
%MSBUILD% BitcrusherChessEngine.sln /p:Configuration=Debug /p:Platform=x64 /t:Clean
%MSBUILD% BitcrusherChessEngine.sln /p:Configuration=Debug /p:Platform=x64
cd ..
bin\Debug\Uci.exe
