...
consteval std::array<uint64_t, BOARD_DIMENSION> createFileBitboards() {
    ...
    array[std::to_underlying(File::A)] =
        convert::toBitboard(Square::A1, Square::A2, Square::A3, Square::A4,
                            Square::A5, Square::A6, Square::A7, Square::A8);
    uint64_t prev_file = array[std::to_underlying(File::A)];
    for (File file :
         {File::B, File::C, File::D, File::E, File::F, File::G, File::H}) {
...
constexpr std::array<uint64_t, BOARD_DIMENSION> FILE_BITBOARDS =
    createFileBitboards();

consteval std::array<uint64_t, BOARD_DIMENSION> createRankBitboards() {
    std::array<uint64_t, BOARD_DIMENSION> array{};
    array[std::to_underlying(Rank::R_1)] =
        convert::toBitboard(Square::A1, Square::B1, Square::C1, Square::D1,
...
constexpr std::array<uint64_t, BOARD_DIMENSION> RANK_BITBOARDS =
    createRankBitboards();
