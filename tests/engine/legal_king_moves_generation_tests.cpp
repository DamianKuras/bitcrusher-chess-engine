...
void generateLegalKingMovesWhite(const BoardState&         board,
                                 ...
                                 TestMoveSink&             sink) {
    bitcrusher::generateLegalKingMoves<Color::WHITE>(board, restriction_context, sink);
}

void generateLegalKingMovesBlack(const BoardState&         board,
                                 const RestrictionContext& restriction_context,
                                 TestMoveSink&             sink) {
    bitcrusher::generateLegalKingMoves<Color::BLACK>(board, restriction_context, sink);
}
} // namespace
